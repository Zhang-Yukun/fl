...
BASE_OUTPUT="${BASE_OUTPUT:-outputs/oracle_attackfreq1_9algo_4mode_$(date +%Y%m%d_%H%M%S)}"
  ...
  for mode in "${modes[@]}"; do
    if [[ "${mode}" == grpc_* ]]; then
      run_grpc \
        ...
        "fedavg-${mode}-uupdate-dmodel-oracle-attackfreq1" \
      ...
      run_grpc \
        "topk_${mode}_uupdate_dmodel_oracle_attackfreq1" \
        "topk10-${mode}-uupdate-dmodel-oracle-attackfreq1" \
      ...
      run_grpc \
        "qsgd_${mode}_uupdate_dmodel_oracle_attackfreq1" \
        "qsgd63-${mode}-uupdate-dmodel-oracle-attackfreq1" \
      ...
      run_grpc \
        "randomk_${mode}_uupdate_dmodel_oracle_attackfreq1" \
        "randomk10-${mode}-uupdate-dmodel-oracle-attackfreq1" \
      ...
      run_grpc \
        "sign_${mode}_uupdate_dmodel_oracle_attackfreq1" \
        "sign-${mode}-uupdate-dmodel-oracle-attackfreq1" \
      ...
      run_grpc \
        "adaptive_${mode}_uupdate_dmodel_oracle_attackfreq1" \
        "adaptive-rdp-${mode}-uupdate-dmodel-oracle-attackfreq1" \
      ...
      run_grpc \
        "qint8_${mode}_uupdate_dmodel_oracle_attackfreq1" \
        "qint8-${mode}-uupdate-dmodel-oracle-attackfreq1" \
      ...
      run_grpc \
        "ega_${mode}_uupdate_dmodel_oracle_attackfreq1" \
        "ega-ed128-dm-ega-pcq127-${mode}-uupdate-dmodel-oracle-attackfreq1" \
