...
BASE_OUTPUT="${BASE_OUTPUT:-outputs/oracle_attackfreq5_maxsamples8_9algo_4mode_mae_$(date +%Y%m%d_%H%M%S)}"
PROJECT_NAME="${PROJECT_NAME:-rare-earth-fl-oracle-attackfreq5-maxsamples8-mae-v1}"
...
main() {
  ...
  if [[ "${RUN_CENTRALIZED}" == "true" ]]; then
    run_centralized \
      centralized_uupdate_dmodel_oracle_attackfreq5_maxsamples8 \
      centralized-oracle-attackfreq5-maxsamples8 \
  ...
  for mode in "${modes[@]}"; do
    if [[ "${mode}" == grpc_* ]]; then
      run_grpc \
        "fedavg_${mode}_uupdate_dmodel_oracle_attackfreq5_maxsamples8" \
        "fedavg-${mode}-uupdate-dmodel-oracle-attackfreq5-maxsamples8" \
      ...
      run_grpc \
        "topk_${mode}_uupdate_dmodel_oracle_attackfreq5_maxsamples8" \
        "topk10-${mode}-uupdate-dmodel-oracle-attackfreq5-maxsamples8" \
      ...
      run_grpc \
        "qsgd_${mode}_uupdate_dmodel_oracle_attackfreq5_maxsamples8" \
        "qsgd63-${mode}-uupdate-dmodel-oracle-attackfreq5-maxsamples8" \
      ...
      run_grpc \
        "randomk_${mode}_uupdate_dmodel_oracle_attackfreq5_maxsamples8" \
        "randomk10-${mode}-uupdate-dmodel-oracle-attackfreq5-maxsamples8" \
      ...
      run_grpc \
        "sign_${mode}_uupdate_dmodel_oracle_attackfreq5_maxsamples8" \
        "sign-${mode}-uupdate-dmodel-oracle-attackfreq5-maxsamples8" \
      ...
      run_grpc \
        "adaptive_${mode}_uupdate_dmodel_oracle_attackfreq5_maxsamples8" \
        "adaptive-rdp-${mode}-uupdate-dmodel-oracle-attackfreq5-maxsamples8" \
      ...
      run_grpc \
        "qint8_${mode}_uupdate_dmodel_oracle_attackfreq5_maxsamples8" \
        "qint8-${mode}-uupdate-dmodel-oracle-attackfreq5-maxsamples8" \
      ...
      run_grpc \
        "ega_${mode}_uupdate_dmodel_oracle_attackfreq5_maxsamples8" \
        "ega-ed128-dm-ega-pcq127-${mode}-uupdate-dmodel-oracle-attackfreq5-maxsamples8" \
