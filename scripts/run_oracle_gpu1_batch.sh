...
BASE_OUTPUT="${BASE_OUTPUT_ROOT}/attackfreq5_1000r_pat100" PROJECT_NAME="rare-earth-fl-oracle-attackfreq5-1000r-pat100-v1" GPU_ID="${GPU_ID:-1}" RUNTIME_DEVICE="${RUNTIME_DEVICE:-cuda:0}" RUN_TAG=oracle_attackfreq5_1000r_pat100 TRACKING_TAG=oracle-attackfreq5-1000r-pat100 ATTACK_ENABLED=true ATTACK_FREQUENCY_ROUNDS=5 ROUNDS=1000 PATIENCE=100 TRAIN_LR=0.0005 ATTACK_LR=0.001 ATTACK_OPTIMIZER=adam LOSS_NAME=mse LOSS_TAG=mse bash scripts/run_oracle_suite.sh --modes centralized,single_sync
