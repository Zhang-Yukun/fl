...
BASE_OUTPUT="${BASE_OUTPUT:-outputs/ega_targeted_noattack_alt_mae_$(date +%Y%m%d_%H%M%S)}"
PROJECT_NAME="${PROJECT_NAME:-rare-earth-ega-targeted-noattack-mae-alt-v1}"
...
run_case \
  "ega_mae_ed152_hd1536_rb3_q127_ema098_pt180" \
  "ega-mae-ed152-hd1536-rb3-q127-ema098-pt180" \
...
run_case \
  "ega_mae_ed168_hd1536_rb3_q127_ema098_pt180" \
  "ega-mae-ed168-hd1536-rb3-q127-ema098-pt180" \
...
run_case \
  "ega_mae_ed160_hd2048_rb4_q127_ema097_pt220" \
  "ega-mae-ed160-hd2048-rb4-q127-ema097-pt220" \
...
run_case \
  "ega_mae_ed152_hd2048_rb3_q191_ema097_pt220" \
  "ega-mae-ed152-hd2048-rb3-q191-ema097-pt220" \
  --override ega.encoded_dim=152 \
  --override ega.hidden_dim=2048 \
  --override ega.residual_blocks=3 \
...
run_case \
  "ega_mae_ed168_hd2048_rb4_q191_ema098_pt220" \
  "ega-mae-ed168-hd2048-rb4-q191-ema098-pt220" \
  --override ega.encoded_dim=168 \
  --override ega.hidden_dim=2048 \
  --override ega.residual_blocks=4 \
  --override ega.quantization_level=191 \
...
run_case \
  "ega_mae_ed176_hd1536_rb4_q223_ema097_pt180" \
  "ega-mae-ed176-hd1536-rb4-q223-ema097-pt180" \
  --override ega.encoded_dim=176 \
  --override ega.hidden_dim=1536 \
  --override ega.residual_blocks=4 \
  --override ega.quantization_level=223 \
  --override ega.normalization_strategy=ema_reported_client_max_abs \
  --override ega.normalization_ema=0.97 \
  --override ega.pretrain.epochs=180 \
  --override ega.pretrain.patience=36 \
