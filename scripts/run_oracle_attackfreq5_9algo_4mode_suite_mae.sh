...
BASE_OUTPUT="${BASE_OUTPUT:-outputs/oracle_attackfreq5_9algo_4mode_mae_$(date +%Y%m%d_%H%M%S)}"
PROJECT_NAME="${PROJECT_NAME:-rare-earth-fl-oracle-attackfreq5-mae-v1}"
