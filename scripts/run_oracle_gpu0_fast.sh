...
BASE_OUTPUT="${BASE_OUTPUT_ROOT}/attackfreq5_mse" PROJECT_NAME="rare-earth-fl-oracle-attackfreq5-v1-fast" GPU_ID="${GPU_ID:-0}" RUNTIME_DEVICE="${RUNTIME_DEVICE:-cuda:0}" bash scripts/run_oracle_attackfreq5_suite.sh --modes centralized,single_sync
