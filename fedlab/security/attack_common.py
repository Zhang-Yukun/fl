"""Shared primitives for reconstruction attacks and result serialization."""
...
def _apply_registered_summary_metrics(record: dict[str, Any], subset: list[AttackResult], *, prefix: str) -> None:
