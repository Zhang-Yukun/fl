...
from fedlab.utils.serialization import add_update, subtract_state
...
class EGAFedAvgMethod(FederatedMethod):
    ...
    def client_update(
        ...
        **_: Any,
        ...
        """Return an encoded gradient aggregation payload from one local model state."""
    ...
    def extract_attack_payload(self, *, result, results, server=None, **_: Any):
        ...
        return decode_attack_view_from_mean_difference(payloads, target_index, server.ega_codec)
