    ...
    def _build_sparse_result(
        ...
        *,
        ...
        return result_cls(
            ...
            **evaluation_kwargs,
            upload_bytes=sparse_update.algorithm_num_bytes + dense_buffer_bytes,
            upload_parameters=sparse_update.algorithm_num_parameters + dense_buffer_parameters,
            parameter_upload_bytes=sparse_update.algorithm_num_bytes + dense_buffer_bytes,
            parameter_upload_parameters=sparse_update.algorithm_num_parameters + dense_buffer_parameters,
            transport_upload_bytes=sparse_update.algorithm_num_bytes + dense_buffer_bytes,
