...
PART_SPECS = (
    ...
    ("run_exp_seed4096_part1.sh", "4096", "59000", "noattack", "single_sync"),
    ("run_exp_seed4096_part2.sh", "4096", "59100", "noattack", "multi_sync"),
    ("run_exp_seed4096_part3.sh", "4096", "59200", "attack", "single_sync"),
    ("run_exp_seed4096_part4.sh", "4096", "59300", "attack", "multi_sync"),
